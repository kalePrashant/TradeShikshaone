      ...
      <main className={styles.main}>
        ...
        <section className={styles.heroSection}>
          ...
          <div className={styles.heroImage}>
            <img src="/images/hero-image.jpg" alt="Stock market trading" />
          </div>
        </section>
        ...
        <section className={styles.featuresSection}>
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>Why Choose TradeShiksha?</h2>
            <p className={styles.sectionSubtitle}>Our platform offers comprehensive learning resources designed for traders of all levels</p>
          </div>
        ...
        <section className={styles.coursesSection}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>Start your trading journey with our most in-demand courses</p>
            ...
            <Link href="/courses?category=stocks">
              <div className={styles.categoryCard}>
                ...
                <div className={styles.categoryContent}>
                  ...
                  <span className={styles.categoryCount}>12 Courses</span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/courses?category=options">
              <div className={styles.categoryCard}>
                ...
                <div className={styles.categoryContent}>
                  ...
                  <span className={styles.categoryCount}>8 Courses</span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/courses?category=technical">
              <div className={styles.categoryCard}>
                ...
                <div className={styles.categoryContent}>
                  ...
                  <span className={styles.categoryCount}>10 Courses</span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/courses?category=fundamental">
              <div className={styles.categoryCard}>
                ...
                <div className={styles.categoryContent}>
                  ...
                  <span className={styles.categoryCount}>7 Courses</span>
                </div>
              </div>
            </Link>
          </div>
        ...
        <section className={styles.testimonialsSection}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSubtitle}>Success stories from traders who transformed their skills with TradeShiksha</p>
          </div>
        ...
        <section className={styles.ctaSection}>
          <div className={styles.ctaContent}>
            ...
            <p>Join thousands of successful traders who have transformed their skills with TradeShiksha</p>
            <div className={styles.ctaButtons}>
              <Link href="/signup" className={styles.primaryButton}>
                Sign Up Now
              </Link>
              <Link href="/courses" className={styles.outlineButton}>
                Browse Courses
              </Link>
            </div>
          </div>
